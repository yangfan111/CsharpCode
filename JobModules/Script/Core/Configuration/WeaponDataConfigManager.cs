...
namespace Core.Configuration
{
    ...
    public class ExpandWeaponDataConfig
    {
        ...
        public ExpandDefaultWeaponLogicConfig detailDefaultWeaponLogicConfig { get; private set; }
        ...
        public ExpandWeaponDataConfig(WeaponConfig weaponConfig)
        {
            ...
            {
                detailDefaultWeaponLogicConfig = new ExpandDefaultWeaponLogicConfig(defaultWeaponLogicConfig);
            }
        }
    }
    ...
    /// 处理武器配置相关逻辑
    /// </summary>
    public class ExpandDefaultWeaponLogicConfig
    {
        ...
        public ExpandDefaultWeaponLogicConfig (DefaultWeaponLogicConfig defaultWeaponLogicConfig)
        {
            if(null == defaultWeaponLogicConfig)
            {
                return;
