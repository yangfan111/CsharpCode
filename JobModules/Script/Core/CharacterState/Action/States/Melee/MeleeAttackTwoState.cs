...
{
    class MeleeAttackTwoState : ActionState
    {
        public MeleeAttackTwoState(ActionStateId id) : base(id)
        {
            ...
            AddTransition(
                ...
                null, (int) ActionStateId.CommonNull, null, 0, new[] {FsmInput.LightMeleeAttackTwo});
            #endregion
            ...
            AddTransition(
                ...
                null, (int) ActionStateId.MeleeAttackOne, null, 0, new[] {FsmInput.LightMeleeAttackOne});
            #endregion
