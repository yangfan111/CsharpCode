...
namespace Core.CharacterState
{
    public class AnimatorParametersHash
    {
        ...
        private AnimatorParametersHash()
        {
            ...
            EnableSightMoveName = "EnableSightMove";
            EnableSightMoveEnableValue = true;
            EnableSightMoveDisableValue = false;
        ...
        #region EnableSightMove
        private string _enableSightMoveName = string.Empty;
        public string EnableSightMoveName
        {
            get { return _enableSightMoveName; }
            set { _enableSightMoveName = value; EnableSightMoveHash = StringToHash(value); }
        }
        public int EnableSightMoveHash { get; private set; }
        public bool EnableSightMoveEnableValue { get; private set; }
        public bool EnableSightMoveDisableValue { get; private set; }
        #endregion
