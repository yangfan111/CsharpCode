...
namespace Core.EntityComponent
{
    ...
    /// <summary>
    /// 两边都有值，使用IGameEntityCompareHandler,内部持有IEntityMapCompareHandler
    /// 只有一边有值，使用IEntityMapCompareHandler
    /// </summary>
    /// <param name="left"></param>
    /// <param name="right"></param>
    /// <param name="handler"></param>
    /// <param name="gameEntityComparator"></param>
    /// <param name="skipMissHandle"></param>
    /// <returns></returns>
    public static class EntityMapCompareExecutor
    {
