...
namespace Core.EntityComponent
{
    public abstract class GameEntityBase : BaseRefCounter, IGameEntity
    {
        ...
        public abstract MyDictionary<int, IGameComponent> SyncLatestComponentDict { get; }
        public abstract MyDictionary<int, IGameComponent> PlayBackComponentDictionary { get; }
        public abstract MyDictionary<int, IGameComponent> SortedCompensationComponentDict { get; }
    ...
    public class GameEntity : GameEntityBase
    {
        ...
        protected MyDictionary<int, IGameComponent> _components = new MyDictionary<int, IGameComponent>(32);
        private volatile List<IGameComponent> _list = new List<IGameComponent>(64);
        private volatile bool _componentListDirty = true;
        private volatile MyDictionary<int, IGameComponent> _syncLatestList = new MyDictionary<int, IGameComponent>(32);
        private volatile bool _syncLatestListDirty = true;
        private volatile MyDictionary<int, IGameComponent> _playbacktList = new MyDictionary<int, IGameComponent>(32);
        private volatile bool _playbacktListDirty = true;
        private volatile MyDictionary<int, IGameComponent> _compensationList = new MyDictionary<int, IGameComponent>(32);
        ...
        public override MyDictionary<int, IGameComponent> SyncLatestComponentDict
        {
            get
            {
        ...
        public override MyDictionary<int, IGameComponent> SortedCompensationComponentDict
        {
            get
            {
