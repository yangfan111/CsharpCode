...
namespace ECM.Components
{
    ...
    {
        protected static readonly LoggerAdapter Logger = new LoggerAdapter(typeof(BaseGroundDetection));
        ...
        public abstract bool ComputeGroundHit(Vector3 position, Quaternion rotation, ControllerHitInfo controllerHitInfo,ref GroundHit groundHitInfo,
            float distance = Mathf.Infinity);
        ...
        public void DetectGround()
        {
            ...
            // Detect ground
            ComputeGroundHit(ObjAdapter.transform.position, ObjAdapter.transform.rotation,
                ref _groundHitInfo, castDistance);
        ...
        public void DetectGroundUseControllerInfo()
        {
            // Prevent hit character's collider during 'grounding' tests
            ...
            // Detect ground
            ComputeGroundHit(ObjAdapter.transform.position, ObjAdapter.transform.rotation, ObjAdapter.GetHitInfo(), 
                ref _groundHitInfo, castDistance);
