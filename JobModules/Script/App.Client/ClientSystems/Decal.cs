...
namespace App.Client.ThreeEyedGames
{
    ...
    {
        private const string _deferredShaderName = "Decalicious/Deferred Spray";
        ...
        void OnWillRenderObject()
        {
            ...
            else if (Material.shader.name.Equals(_deferredShaderName))
                RenderMode = DecalRenderMode.Deferred;
            else if (Material.shader.name.Equals(_unlitShaderName))
