...
namespace App.Client.SceneManagement.DistanceCulling
{
    class Constants
    {
        ...
        {
            new DistCullingParam { Cat = DistCullingCat.Detail, Dist = 20 * 20 },
            new DistCullingParam { Cat = DistCullingCat.Near, Dist = 50 * 50 },
            new DistCullingParam { Cat = DistCullingCat.Median, Dist = 150 * 150 }, 
            new DistCullingParam { Cat = DistCullingCat.Far, Dist = 1000 * 1000 }, 
        };
