...
namespace App.Client.GameModules.Ui.ViewModels.Common
{
    public class CommonWeaponBagViewModel : ViewModelBase, IUiViewModel
    {
		...
		void ViewBind(CommonWeaponBagView view)
		{
		...
		void DataInit(CommonWeaponBagView view)
		{
            _show = view.Show.activeSelf;
            _closeTipText = view.CloseTipText.text;
		}


		void SaveOriData(CommonWeaponBagView view)
		{
            view.oriShow = _show;
            view.oriCloseTipText = _closeTipText;
		}
