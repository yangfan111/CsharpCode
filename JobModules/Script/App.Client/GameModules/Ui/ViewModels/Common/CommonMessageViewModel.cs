...
{
    public class CommonMessageViewModel : ViewModelBase, IUiViewModel
    {
        private class CommonMessageView : UIView
        {
        ...
        public void CreateBinding(GameObject obj)
        {
			...
			bool bFirst = false;
			var view = obj.GetComponent<CommonMessageView>();
			if(view == null)
			{
				bFirst = true;
				view = obj.AddComponent<CommonMessageView>();
				view.FillField();
			}
			DataInit(view);
			SpriteReset();
		...
		private void EventTriggerBind(CommonMessageView view)
		{
		}
        ...
        static CommonMessageViewModel()
        {
            Type type = typeof(CommonMessageViewModel);
		...
		void ViewBind(CommonMessageView view)
		{
		     BindingSet<CommonMessageView, CommonMessageViewModel> bindingSet =
                view.CreateBindingSet<CommonMessageView, CommonMessageViewModel>();
		...
		void DataInit(CommonMessageView view)
		{
		...
		void SaveOriData(CommonMessageView view)
		{
        ...
        public string ResourceAssetName { get { return "CommonMessage"; } }
