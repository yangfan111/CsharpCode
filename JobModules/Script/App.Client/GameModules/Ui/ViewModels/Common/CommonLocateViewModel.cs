...
{
    public class CommonLocateViewModel : ViewModelBase, IUiViewModel
    {
        private class CommonLocateView : UIView
        {
        ...
        static CommonLocateViewModel()
        {
            Type type = typeof(CommonLocateViewModel);
