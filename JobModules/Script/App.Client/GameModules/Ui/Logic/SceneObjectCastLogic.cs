...
namespace App.Client.GameModules.Ui.Logic
{
    public class SceneObjectCastLogic : AbstractCastLogic 
    {
        ...
        public override void OnAction()
        {
            ...
            player.modeLogic.ModeLogic.SendPickup(entityId, itemId, category, count);
        }
        ...
        protected override void DoSetData(PointerData data)
        {
            ...
            {
                case ECategory.Weapon:
                    var itemCfg = SingletonManager.Get<WeaponConfigManager>().GetConfigById(itemId);
                    if(null != itemCfg)
                    {
                ...
                case ECategory.Avatar:
                    ...
                    break;
                case ECategory.WeaponPart:
                    var part = SingletonManager.Get<WeaponPartSurvivalConfigManager>().GetConfigById(itemId);
                    if(null != part)
                    {
