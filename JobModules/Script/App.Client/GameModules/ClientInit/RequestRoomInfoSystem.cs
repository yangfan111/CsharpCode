    ...
    public class RequestRoomInfoSystem : IInitializeSystem, INetworkMessageHandler, IExecuteSystem
    {
        ...
        public void Initialize()
        {
            ...
            if (SharedConfig.IsOffline)
            {
                ...
                _contexts.session.commonSession.WeaponModeLogic = ClientGameModeLogicFactoryManager.GetModeLogicFactory(_contexts, SharedConfig.ModeId).CreateWeaponModeLogic();
