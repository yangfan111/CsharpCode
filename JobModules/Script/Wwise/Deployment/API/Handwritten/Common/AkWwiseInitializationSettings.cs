...
public class AkWwiseInitializationSettings : AkCommonPlatformSettings
{
	...
	public static bool InitializeSoundEngine()
	{
...
#endif
        var writer = File.CreateText(Path.Combine(Application.dataPath,"log0.txt"));
        writer.WriteLine("S1");
        ...
        var basePathToSet = AkUtilities.GetWiseBankFolder_Full();  //AkBasePathGetter.GetSoundbankBasePath();
        writer.WriteLine("S4");
