...
public class WwiseSettings
{
    ...
    public const string WwiseSettingsFilename = "";

    private static WwiseSettings s_Instance;
    public bool CopySoundBanksAsPreBuildStep { get { return false; } }
    public bool CreatedPicker
    {
        get
        {
            return AudioPluginManagement.GetCreatePacker();
        }
    }
    public bool CreateWwiseGlobal
    {
        get
        {
            return AudioPluginManagement.GetCreateWwiseGlobal();
        }
    }
    public bool CreateWwiseListener
    {
        get
        {
            return AudioPluginManagement.GetCreateWwiseListener();
        }
    }
    public bool GenerateSoundBanksAsPreBuildStep { get { return false; } }
    public bool ShowMissingRigidBodyWarning { get { return false; } }
    ...
    public string WwiseInstallationPathMac
    {
        ...
        get
        {
            return AudioPluginManagement.DeveloperWwiseInstallationPath;
        }
    }
    ...
    public string WwiseProjectPath
    {
        get
        {
            ...
            return AudioPluginManagement.DeveloperWwiseProjectPath;
        }
    }
    ...
    public static WwiseSettings LoadSettings(bool ForceLoad = false)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                //	Settings.DeveloperWwiseProjectPath = "";
                //else
                //{
                //	Settings.DeveloperWwiseProjectPath =
...
public partial class AkUtilities
{
    ...
    {
        var Settings = WwiseSettings.LoadSettings();
        var wwiseProjectFullPath = AudioPluginManagement.DeveloperWwiseProjectPath; // GetFullPath(UnityEngine.Application.dataPath, AKCustomizeSettings.DeveloperWwiseProjectPath);
    ...
    public static bool GetWwiseSoundBankDestinationFoldersByUnityPlatform(UnityEditor.BuildTarget target,
        string DeveloperWwiseProjectPath, out string[] paths, out string[] platformNames)
    {
        paths = null;
        platformNames = null;
        ...
        try
        {
            if (DeveloperWwiseProjectPath.Length == 0)
                return false;

            var doc = new System.Xml.XmlDocument();
            doc.Load(DeveloperWwiseProjectPath);
    ...
    private static void UpdateSoundbanksDestinationFolders(string DeveloperWwiseProjectPath)
    {
        try
        {
            if (DeveloperWwiseProjectPath.Length == 0)
            ...
            if (!System.IO.File.Exists(DeveloperWwiseProjectPath))
                return;

            var t = System.IO.File.GetLastWriteTime(DeveloperWwiseProjectPath);
        ...
        catch (System.Exception ex)
        {
            ...
            UnityEngine.Debug.LogError("Wwise: Error while reading project " + DeveloperWwiseProjectPath + ".  Exception: " + ex.Message);
        }
    }

    // Parses the .wproj to find out where soundbanks are generated for the given path.
    public static string GetWwiseSoundBankDestinationFolder(string Platform, string DeveloperWwiseProjectPath)
    {
        try
        {
            UpdateSoundbanksDestinationFolders(DeveloperWwiseProjectPath);
    ...
    public static bool EnableBoolSoundbankSettingInWproj(string SettingName, string DeveloperWwiseProjectPath)
    {
        try
        {
            if (DeveloperWwiseProjectPath.Length == 0)
            ...
            doc.Save(DeveloperWwiseProjectPath);
        }
        catch (System.Exception)
        {
            return false;
    ...
    public static bool SetSoundbankHeaderFilePath(string DeveloperWwiseProjectPath, string SoundbankPath)
    {
        try
        {
            if (DeveloperWwiseProjectPath.Length == 0)
