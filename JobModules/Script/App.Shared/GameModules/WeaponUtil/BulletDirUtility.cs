...
namespace App.Shared.GameModules.Weapon
{
    ...
    public class BulletDirUtility
    {
        ...
        {
            var yaw = controller.RelatedOrientation.Yaw - controller.RelatedOrientation.AccPunchPitchValue * 2;
            var pitch = controller.RelatedOrientation.Pitch - controller.RelatedOrientation.AccPunchYawValue * 2;
