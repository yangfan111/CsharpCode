    ...
    public class CameraPostUpdateSystem : IUserCmdExecuteSystem,IRenderSystem
    {
        ...
        public void ExecuteUserCmd(IUserCmdOwner owner, IUserCmd cmd)
        {
            ...
            playerEntity.cameraStateUpload.ThirdPersonCameraPostion =
                playerEntity.appearanceInterface.Appearance.IsFirstPerson
                    ? playerEntity.thirdPersonDataForObserving.ThirdPersonOutput.Position
                    : playerEntity.cameraFinalOutputNew.Position;
        }
...
//                playerEntity.cameraArchor.ArchorPosition;
            ...
            if (playerEntity.gamePlay.BeingObserved && playerEntity.appearanceInterface.Appearance.IsFirstPerson)
            ...
            Vector3 punchRotation, PlayerEntity player)
        {
            ...
            if (player.stateInterface.State.GetActionState() != ActionInConfig.Gliding &&
                ...
                RealArchorOffset(calsOut, player, ref realArchorStart);
...
//            Logger.DebugFormat("CameraCollision: 定点高:{0}",realArchorStart.magnitude, );
        ...
        public void RealArchorOffset(CameraStateOutputNewComponent calsOut, PlayerEntity player, ref Vector3 startPoint)
        {
