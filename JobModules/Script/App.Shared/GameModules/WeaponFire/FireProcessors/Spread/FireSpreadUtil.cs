...
namespace App.Shared.GameModules.Weapon.Behavior
{
    public static class FireSpreadFormula
    {
        ...
        public static void ApplyPistolFinalSpread(float spreadScaleFactor, SpreadScale spreadScale, WeaponRuntimeDataComponent runtimeDataComponent)
        {
            runtimeDataComponent.LastSpreadX = (1 - runtimeDataComponent.Accuracy) * spreadScaleFactor * spreadScale.ScaleX;
            runtimeDataComponent.LastSpreadY = (1 - runtimeDataComponent.Accuracy) * spreadScaleFactor * spreadScale.ScaleY;
        }

        public static void ApplyFixedFinalSpread(float baseSpread, SpreadScale spreadScale, WeaponRuntimeDataComponent runtimeDataComponent)
        {
    ...
    public static class FireSpreadProvider
    {
        ...
        public static float GetSpreadScaleFactor(SniperSpreadLogicConfig snipperSpreadLogicConfig, PlayerWeaponController controller)
        {
            float param = 0f;
        ...
        private static float GetSpreadFactor(Spread spreadAimCfg, float fastMoveSpeed, PlayerWeaponController controller)
        {
            //fst layer
            var posture = controller.RelatedCharState.GetCurrentPostureState();
