...
namespace App.Shared.GameModules.Player.Actions.ClimbPackage
{
    public class ClimbUp50Cm : IAction
    {
        private static LoggerAdapter _logger = new LoggerAdapter(typeof(ClimbUp50Cm));
        ...
        public ClimbUp50Cm(GenericActionKind kind)
        {
            _kind = kind;
        }
        ...
        public void AnimationBehaviour()
        {
            ...
            if (PlayingAnimation)
            {
                if (!_thirdPersonAnimator.isMatchingTarget && _thirdPersonAnimator.GetCurrentAnimatorStateInfo(0).IsName("ClimbStart") &&
                    ...
                    _thirdPersonAnimator.MatchTarget(MatchTarget, Quaternion.identity, AvatarTarget.RightFoot,
