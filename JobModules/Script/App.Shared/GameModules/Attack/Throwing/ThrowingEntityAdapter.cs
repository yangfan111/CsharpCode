...
namespace App.Shared.GameModules.Throwing
{
    public class ThrowingEntityAdapter
    {
        ...
        public float Gravity { get { return _throwingEntity.throwingData.ThrowConfig.Gravity; } }
        public float VelocityDecay { get { return _throwingEntity.throwingData.ThrowConfig.VelocityDecay; } }
        ...
        public float BaseDamage { get { return _throwingEntity.throwingData.ThrowConfig.BaseDamage; } }
        public float DamageRadius { get { return _throwingEntity.throwingData.ThrowConfig.DamageRadius; } }
