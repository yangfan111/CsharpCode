...
namespace App.Shared.Audio
{
    ...
    public class AKBankAtom : AudioRefCounter
    {
        ...
        public AKBankAtom(string bnkName, Action<BankLoadResponseStruct> in_loadFinishEvt) : this(bnkName,
            AudioBank_LoadAction.Normal, AudioBnk_LoadModel.Sync)
        {
        }
    ...
    public class AKSwitchAtom
    {
        ...
        public static Action<AKSwitchAtom, GameObject> onImplentment;
    ...
    public class AKEventAtom : AudioRefCounter
    {
        ...
        public static Action<AKEventAtom, GameObject, bool> onImplentment;
        ...
        {
            //    DebugUtil.MyLog("PostEvent(GameObject target)!");
