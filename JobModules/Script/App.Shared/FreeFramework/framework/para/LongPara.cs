...
{
	[System.Serializable]
	public class LongPara : AbstractPara, IComparable<com.wd.free.para.LongPara>, IRule
    {
		...
		private static ParaPool pool = new ParaPool(new com.wd.free.para.LongPara());
