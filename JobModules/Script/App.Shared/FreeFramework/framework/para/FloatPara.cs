...
{
	[System.Serializable]
	public class FloatPara : AbstractPara, IComparable<com.wd.free.para.FloatPara>, IRule
    {
		...
		private static ParaPool pool = new ParaPool(new com.wd.free.para.FloatPara());
