...
{
	[System.Serializable]
	public class DoublePara : AbstractPara, IComparable<com.wd.free.para.DoublePara>, IRule
    {
		...
		internal static ParaPool pool = new ParaPool(new com.wd.free.para.DoublePara());
        ...
        {
            return (int)ERuleIds.DoublePara;
        }
    }
}
