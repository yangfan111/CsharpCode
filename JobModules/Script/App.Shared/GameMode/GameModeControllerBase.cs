...
namespace App.Shared
{
    ...
    /// </summary>
    public class GameModeControllerBase : ModuleLogicActivator<GameModeControllerBase>, ISessionMode, IModeProcessListener, IPickupHandler, IReservedBulletHandler, IWeaponSlotsLibrary
    {
