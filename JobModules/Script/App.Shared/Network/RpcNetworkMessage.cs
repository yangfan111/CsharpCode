...
namespace RpcNetwork.RpcNetwork
{
    ...
    {
        private static LoggerAdapter _logger = new LoggerAdapter(typeof(RpcNetworkMessageManager));
    ...
    public interface IRpcNetworkMessageManager
    {
        ...
        void Send(INetworkChannel channel, bool logMsg, string messageName, params IMessage[] messageBodys);
        void Test();
    }
