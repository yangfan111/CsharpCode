...
namespace App.Shared.Util
{
    public static class WeaponPartsUtil
    {
        ...
        public static WeaponPartsStruct GetParts(this WeaponDataComponent comp)
        {
            var result = new WeaponPartsStruct
            {
        ...
        public static void ApplyParts(this WeaponDataComponent comp, WeaponPartsStruct attach)
        {
        ...
        public static void CopyToWeaponComponentWithDefaultParts(this WeaponInfo weaponInfo, WeaponDataComponent weaponComponnet)
        {
