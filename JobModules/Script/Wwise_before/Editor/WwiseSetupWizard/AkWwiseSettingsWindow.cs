...
////			UnityEditor.EditorGUILayout.SelectableLabel(WwiseSetupWizard.Settings.DeveloperWwiseProjectPath, "textfield",
...
////					WwiseSetupWizard.Settings.DeveloperWwiseProjectPath));
...
////            string wwiseInstallationPath = @"E:\Wwise 2017.2.8.6698";

////#if UNITY_EDITOR_OSX
////			wwiseInstallationPath = WwiseSetupWizard.Settings.WwiseInstallationPathMac;
////#else
////            wwiseInstallationPath = WwiseSetupWizard.Settings.DeveloperWwiseProjectPath;
////#endif
...
////#else
////					WwiseSetupWizard.Settings.DeveloperWwiseProjectPath = wwiseInstallationPath;
////#endif
////				}
...
//            {
//                UnityEngine.GUILayout.Label(new UnityEngine.GUIContent(description, tooltip), UnityEngine.GUILayout.Width(330));
//                UnityEditor.EditorGUILayout.LabelField(WwiseSetupWizard.Settings.SoundbankPath,
//                    UnityEngine.GUILayout.Height(17));

//                //if (UnityEngine.GUILayout.Button("...", UnityEngine.GUILayout.Width(30)))
//                //{
//                //    //var OpenInPath = System.IO.Path.GetDirectoryName(WwiseSetupWizard.Settings.SoundbankPath);
...
//		    WwiseSetupWizard.Settings == null)
...
//		// DrawSettingsPart modifies WwiseSetupWizard.Settings.DeveloperWwiseProjectPath directly.
