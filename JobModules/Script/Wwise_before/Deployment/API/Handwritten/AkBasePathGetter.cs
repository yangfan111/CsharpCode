...
//	}
...
#if UNITY_EDITOR
	/// <summary>
	///-copy soundbank相关，不用管     Determines the platform base path for use within the Editor.
	/// </summary>
  ...
  //      var WwiseProjectFullPath = Settings.WwiseProjectPath;//AkUtilities.GetFullPath(UnityEngine.Application.dataPath, Settings.WwiseProjectPath);
