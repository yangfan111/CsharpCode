...
namespace Core.Utils.System46
{
    ...
    //     C# source
    //          throw new ArgumentNullException("key", MyEnvironment.GetResourceString("ArgumentNull_Key"));
    //     IL code:
    //          IL_0003:  ldstr      "key"
    ...
    class MyEnvironment
    {
        public static string GetResourceString(string fmt, params object[] values)
        {
            return fmt;
        }
    }
    ...
    internal static class ThrowHelper
    {
        ...
        {
            throw new ArgumentException(MyEnvironment.GetResourceString(GetResourceName(resource)));
        }
        ...
        {
            throw new SerializationException(MyEnvironment.GetResourceString(GetResourceName(resource)));
        }
