...
namespace Core.Utils
{
    ...
    internal sealed class SystemCollectionDebugView<T>
    {
        private ICollection<T> _collection;

        public SystemCollectionDebugView(ICollection<T> collection)
        {
            if (collection == null)
    ...
    [ComVisible(false)]
    [DebuggerTypeProxy(typeof(SystemCollectionDebugView<>))]
           ...
           , ISerializable, IDeserializationCallback
    {
        ...
        {
            ValidateNode(node);
            LinkedListNode<T> result = LinkedListNode<T>.Allocate(node.list, value);
        ...
        {
            LinkedListNode<T> result = LinkedListNode<T>.Allocate(this, value);
            if (head == null)
            {
        ...
        public void CopyTo(T[] array, int index)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("index", "array too small");
            }

            if (array.Length - index < Count)
            {
                throw new ArgumentException("arry too small");
            }
        ...
        {
            // Customized serialization for MyLinkedList.
        ...
        {
            Debug.Assert(head == null && count == 0, "MyLinkedList must be empty when this method is called!");
...
#endif
        {
            ...
            const string LinkedListName = "MyLinkedList";
            ...
            void IDeserializationCallback.OnDeserialization(Object sender)
            {
                ...
                {
                    node = list.First;
                    // We don't care if we can point to the correct node if the MyLinkedList was changed   
    ...
    // Note following class is not serializable since we customized the serialization of MyLinkedList. 
    [ComVisible(false)]
