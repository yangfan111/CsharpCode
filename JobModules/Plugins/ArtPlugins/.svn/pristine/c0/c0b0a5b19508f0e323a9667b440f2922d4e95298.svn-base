...
public class DynamicBone : MonoBehaviour
{
    ...
    private void Awake()
    {
        if (PlayerPrefs.HasKey("unity_server_mode")) {
            Destroy(this);
        }
    }
    void Start()
...
#endif
              v.x=Mathf.Clamp(v.x, -10000000, 10000000);
                v.y = Mathf.Clamp(v.y, -10000000, 10000000);
                v.z = Mathf.Clamp(v.z, -10000000, 10000000);
                v2.x = Mathf.Clamp(v2.x, -10000000, 10000000);
                v2.y = Mathf.Clamp(v2.y, -10000000, 10000000);
                v2.z = Mathf.Clamp(v2.z, -10000000, 10000000);
