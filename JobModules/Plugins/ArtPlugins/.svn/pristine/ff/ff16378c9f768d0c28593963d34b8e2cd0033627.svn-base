...
namespace DigitalOpus.MB.Core
{
    ...
    public class ShaderTextureProperty
    {
        ...
        /// 构造函数
        /// </summary>
        /// <param name="n">纹理属性名称</param>
        /// <param name="norm">是否为法线</param>
    ...
    public class MB3_TextureCombiner
    {
        ...
        /// <summary>
        /// 记录是否缩放2的幂的图片使其周围用atlasPadding包边，用于提高打包效率
        /// </summary>
        ...
        public static void RunCorutineWithoutPause(IEnumerator cor, int recursionDepth)                 // 编辑器合并图集使用
        {
            if (recursionDepth == 0)
            {
	    ...
	    *  <remarks>Combines meshes and generates texture atlases</remarks> */
        public bool CombineTexturesIntoAtlases(ProgressUpdateDelegate progressInfo, MB_AtlasesAndRects resultAtlasesAndRects,
                                                Material resultMaterial, List<GameObject> objsToMesh, List<Material> allowedMaterialsFilter,
                                                MB2_EditorMethodsInterface textureEditorMethods = null, List<AtlasPackingResult> packingResults = null, bool onlyPackRects = false)
        {
        ...
        /// 创建图集的协程（编辑器合并图集使用）
        /// </summary>
        /// <param name="progressInfo">进度更新代理函数</param>
        /// <param name="resultAtlasesAndRects">最终图集和uv矩形映射记录结果</param>
        /// <param name="resultMaterial">合并后的材质</param>
        /// <param name="objsToMesh">所有待合并的物体列表</param>
        /// <param name="allowedMaterialsFilter">是否允许材质过滤</param>
        /// <param name="textureEditorMethods">编辑器方法</param>
        /// <param name="coroutineResult">记录协程运行结果</param>
        /// <param name="maxTimePerFrame">每帧的最大时间</param>
        /// <param name="packingResults">图集打包结果列表</param>
        /// <param name="onlyPackRects">是否仅打包矩形</param>
        public IEnumerator CombineTexturesIntoAtlasesCoroutine(ProgressUpdateDelegate progressInfo, MB_AtlasesAndRects resultAtlasesAndRects,
                                                                Material resultMaterial, List<GameObject> objsToMesh, List<Material> allowedMaterialsFilter,
                                                                MB2_EditorMethodsInterface textureEditorMethods = null, CombineTexturesIntoAtlasesCoroutineResult coroutineResult = null,
                                                                float maxTimePerFrame = .01f, List<AtlasPackingResult> packingResults = null, bool onlyPackRects = false)
        {
            // 版本检测
        ...
        /// <param name="resultAtlasesAndRects"></param>
        /// <param name="resultMaterial"></param>
        /// <param name="objsToMesh"></param>
        /// <param name="allowedMaterialsFilter"></param>
        /// <param name="textureEditorMethods"></param>
        /// <param name="atlasPackingResult"></param>
        /// <param name="onlyPackRects"></param>
        /// <returns></returns>
        IEnumerator _CombineTexturesIntoAtlases(ProgressUpdateDelegate progressInfo, CombineTexturesIntoAtlasesCoroutineResult result,
        ...
        /// </summary>
        /// <param name="resultMaterial">合并后的材质</param>
        /// <param name="texPropertyNames">纹理属性列表</param>
        /// <param name="objsToMesh">待合并的网格</param>
        /// <param name="allowedMaterialsFilter">允许材质过滤器后的网格</param>
        /// <param name="distinctMaterialTextures">不同材质纹理集合</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="progressInfo">更新代理函数</param>
        /// <param name="result">创建图集的协程结果</param>
        /// <param name="resultAtlasesAndRects"></param>
        ...
        IEnumerator __CombineTexturesIntoAtlases(ProgressUpdateDelegate progressInfo, CombineTexturesIntoAtlasesCoroutineResult result, MB_AtlasesAndRects resultAtlasesAndRects, MB3_TextureCombinerPipeline.TexturePipelineData data, MB2_EditorMethodsInterface textureEditorMethods)
        {
			...
			*/
            ...
            // 由于使用自定义纹理图集合并方法，所以避免重导入纹理资源以开启读写功能
