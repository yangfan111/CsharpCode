...
[CustomEditor(typeof(SEScreenSpaceShadows))]
public class SEScreenSpaceShadowsEditor : Editor
{
	...
	void OnEnable()
	{
        ...
        instance = target as SEScreenSpaceShadows;
	}
	...
	public override void OnInspectorGUI()
	{
        ...
        if (!instance.GetCompatibleRenderPath())
        {
            EditorGUILayout.HelpBox("This effect requires the Deferred rendering path! Change Rendering Path in camera settings to Deferred.", MessageType.Warning);
        }
		...
		EditorGUILayout.PropertyField(highResolution, new GUIContent("High Resolution", "Use full resolution of camera or just half of it."));
