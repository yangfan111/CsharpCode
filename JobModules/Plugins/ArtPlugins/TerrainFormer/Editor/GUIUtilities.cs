...
namespace JesseStiller.TerrainFormerExtension {
    internal static class GUIUtilities {
        ...
        /// <returns>Wether the button was pressed or not.</returns>
        ...
        internal static string BrushSelectionGrid(string previouslySelected) {
            ...
            List<TerrainBrush> terrainBrushesOfCurrentType = new List<TerrainBrush>();
            ...
            if(selectedBrushTab != "All" && BrushCollection.terrainBrushTypes.ContainsKey(selectedBrushTab)) {
                ...
                terrainBrushesOfCurrentType.AddRange(BrushCollection.brushes.Values);
            }
            ...
            foreach(TerrainBrush terrainBrush in terrainBrushesOfCurrentType) {
        ...
        internal static int TextureSelectionGrid(int previouslySelected, Texture2D[] icons) {
            ...
            for(int i = 0; i < icons.Length; i++) { 
                ...
                if(currentEvent.type == EventType.Repaint) {
                    ...
                    Styles.gridList.Draw(selectionRect, GUIContent.none, false, false, i == previouslySelected, false);
                    Styles.gridList.Draw(imageRect, icons[i], false, false, false, false);
                }
