...
namespace JesseStiller.TerrainFormerExtension {
    ...
    internal static class GUIContents {
        ...
        internal static readonly GUIContent mouldAllIterations = new GUIContent("Mould Iterations", "Sets how many times the mould tool will be applied when clicking \"Mould All\".");
