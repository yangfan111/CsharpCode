...
namespace JesseStiller.TerrainFormerExtension {
    public class CreateTerrainGrid : EditorWindow {
        ...
        void OnEnable() {
            ...
            if(TerrainFormerEditor.settings == null) TerrainFormerEditor.InitializeSettings();
            
            terrainActiveTexture = AssetDatabase.LoadAssetAtPath<Texture2D>(TerrainFormerEditor.settings.mainDirectory + "Textures/TerrainActive.png");
            terrainInactiveTexture = AssetDatabase.LoadAssetAtPath<Texture2D>(TerrainFormerEditor.settings.mainDirectory + "Textures/TerrainInactive.png");
            arrowVerticalTexture = AssetDatabase.LoadAssetAtPath<Texture2D>(TerrainFormerEditor.settings.mainDirectory + "Textures/ArrowVertical.psd");
            arrowHorizontalTexture = AssetDatabase.LoadAssetAtPath<Texture2D>(TerrainFormerEditor.settings.mainDirectory + "Textures/ArrowHorizontal.psd");
            mutedTextFieldFocusedTexture = AssetDatabase.LoadAssetAtPath<Texture2D>(TerrainFormerEditor.settings.mainDirectory + "Textures/MutedTextFieldFocused.psd");

#if UNITY_5_3_OR_NEWER
            fileNamePrefix = SceneManager.GetActiveScene().name;
#else
            fileNamePrefix = Application.loadedLevelName;
#endif
