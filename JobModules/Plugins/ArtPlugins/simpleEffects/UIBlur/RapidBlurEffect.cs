...
namespace ArtPlugins
{
    ...
    public class RapidBlurEffect : MonoBehaviour
    {
        ...
        //指定Shader名称
        private string ShaderName = "SimpleEffects/RapidBlurEffect";
        private string ShaderNameMask = "SimpleEffects/RapidBlurEffectMask";
        ...
        //着色器和材质实例
        public Shader CurShaderMask;
        private Material CurMaterialMask;

        //几个用于调节参数的中间变量
        public static int ChangeValue;
        public static float ChangeValue2;
        public static int ChangeValue3;
        public Rect rect1=Rect.MinMaxRect(0,0,1,1);
        public Rect rect2=Rect.MinMaxRect(0,0,1,1);
        ...
        Material materialMask
        {
            get
            {
                if (CurMaterialMask == null)
                {
                    CurMaterialMask = new Material(CurShaderMask);
                    CurMaterialMask.hideFlags = HideFlags.HideAndDontSave;
                }
                return CurMaterialMask;
            }
        }
        #endregion
        ...
        void Start()
        {
            ...
            //找到当前的Shader文件
            CurShaderMask = Shader.Find(ShaderNameMask);
        ...
        void OnRenderImage(RenderTexture sourceTexture, RenderTexture destTexture)
        {
            ...
            if (CurShader != null)
            {
                materialMask.SetVector("_MaskRect1", new Vector4( rect1.xMin,rect1.yMin,rect1.xMax,rect1.yMax));
                materialMask.SetVector("_MaskRect2", new Vector4( rect2.xMin,rect2.yMin,rect2.xMax,rect2.yMax));
                //【0】参数准备
                ...
                CurMaterialMask.SetTexture("_OriginTex", sourceTexture);
                Graphics.Blit(renderBuffer, destTexture,CurMaterialMask);
                //清空renderBuffer
                RenderTexture.ReleaseTemporary(renderBuffer);
