...
[UnityEditor.CustomEditor(typeof(AudioCustomizeSettingsComponent))]
public class VoyagerSettingComponentInspector : UnityEditor.Editor
{
    ...
    private AudioCustomizeSettingsComponent targetComponent;
    private bool flagFirstEnable = false;
    public void OnEnable()
    {
        flagFirstEnable = true;
        targetComponent = target as AudioCustomizeSettingsComponent;
