...
namespace Core
{
    ...
    /// </summary>
    public interface IPlayerWeaponActionLogic
    {
        /// <summary>
        /// 装备武器到手上（包括动作）
        /// </summary>
        /// <param name="slot"></param>
        void DrawWeapon(EWeaponSlotType slot);
        /// <summary>
        /// 装备武器到手上（无动作）
        /// </summary>
        /// <param name="player"></param>
        /// <param name="slot"></param>
        void TryMountWeapon(EWeaponSlotType slot);
        /// <summary>
        /// 卸除当前武器（有动作）
        /// </summary>
        ...
        void UnmountWeapon(Action callback);
        /// <summary>
        /// 强制卸除当前武器（无动作）
        /// </summary>
        void ForceUnmountWeapon();
        /// <summary>
        /// 捡起武器，捡起的武器会拿到手上（有动作）
        /// </summary>
        ...
        /// </summary>
        void DropWeapon(EWeaponSlotType slot);
        /// <summary>
        /// 切换武器 
        /// </summary>
        /// <param name="slot"></param>
        ...
        /// </summary>
        /// <param name="slot"></param>
        void RemoveWeaponNoInterrupt(EWeaponSlotType slot);
        /// <summary>
        /// 消耗武器
        /// </summary>
