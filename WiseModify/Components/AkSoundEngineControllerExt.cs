...
public class AkSoundEngineControllerExt
{
	...
	private static AkSoundEngineControllerExt ms_Instance;

	public static AkSoundEngineControllerExt Instance
	{
		get
		{
			if (ms_Instance == null)
				ms_Instance = new AkSoundEngineControllerExt();

			return ms_Instance;
		}
	}

	private AkSoundEngineControllerExt()
	{
#if UNITY_EDITOR
...
// This is for platforms that only have a specific file location for persistent data.
	...
	public void LateUpdate()
	{
		...
		AkBankManagerExt.DoUnloadBanks();
		AkSoundEngine.RenderAudio();
	}
    public delegate void OnEnineStarupReady(AkInitializerExt initializer);
    public event OnEnineStarupReady starupReadyEvt;
    

	public void Init(AkInitializerExt akInitializer)
	{
		...
		UnityEditor.EditorApplication.update += LateUpdate;
#endif
        if (starupReadyEvt != null)
            starupReadyEvt(akInitializer);
	...
	private AkInitializerExt TheAkInitializer = null;
	...
	private bool IsTheSingleOwningInitializer(AkInitializerExt akInitializer)
	{
