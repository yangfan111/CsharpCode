...
[UnityEngine.RequireComponent(typeof(AkGameObjExt))]
...
public class AkAudioListener : UnityEngine.MonoBehaviour
{
	...
	private System.Collections.Generic.List<AkGameObjExt> EmittersToStartListeningTo = 
		new System.Collections.Generic.List<AkGameObjExt>();
	private System.Collections.Generic.List<AkGameObjExt> EmittersToStopListeningTo = 
		new System.Collections.Generic.List<AkGameObjExt>();
	...
	public void StartListeningToEmitter(AkGameObjExt emitter)
	{
		EmittersToStartListeningTo.Add(emitter);
		EmittersToStopListeningTo.Remove(emitter);
	}

	public void StopListeningToEmitter(AkGameObjExt emitter)
	{
	...
	private void Awake()
	{
		var akGameObj = GetComponent<AkGameObjExt>();
