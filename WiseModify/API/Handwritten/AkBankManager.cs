...
// No bank decoding on Nintendo switch
	...
	private class AsyncBankHandle : BankHandle
	{
        ...
        private readonly System.Object bankCallback_cookie;
        private readonly bool hasCookie;
			...
			uint in_memPoolId, object in_Cookie)
		{
            ...
            {
                if(handle.hasCookie)
                    callback(in_bankID, in_pInMemoryBankPtr, in_eLoadResult, in_memPoolId, in_Cookie);
                else
