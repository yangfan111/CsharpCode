...
namespace   App.Shared.Audio
{
    ...
    public class AKAudioDispatcher
    {
        ...
        ///全局状态控制
        public AKRESULT ChangeGlobalState(int groupId, string state)
        {
        ...
        public AKRESULT ChangeSwitchState(int groupId, string state, GameObject target)
        {
        ...
        public void PostEvent(int eventId, GameObject target)
        {
            ...
            AKRESULT ret = bankLoader.TryLoadBnk(evtCfg.name);
